...
if (window.innerWidth <= 900) {
    ...
    // Adding Carrier_text at the biginning of the h4
    document
    ...
    para[0].classList.add("Carrier_Txt");
    para[1].classList.add("Carrier_Txt");
    para[2].classList.add("Carrier_Txt");
    ...
    const iPhone_specialistChat = document.getElementById("iPhone_specialistChat");
    document
        .getElementById("phone_div")
        .insertAdjacentElement("afterend", iPhone_specialistChat);
} else {
    //  alert("Resolution is " + window.innerWidth + " X " + window.innerHeight + "." )
    document.getElementById("iPhone_specialistChat").remove();
